...
import { j as defineHandlerCallback, G as resolveManifestAssetLink, H as resolveManifestCssLink, p as getManifestScriptFormat, I as rootRouteId, q as getNormalizedURL, r as getOrigin, c as attachRouterServerSsrUtils, g as createSerializationAdapter, f as createRawStreamRPCPlugin, w as invariant, y as isNotFound, z as isRedirect, A as isResolvedRedirect, E as mergeHeaders, m as executeRewriteInput, i as defaultSerovalPlugins, D as makeSerovalPlugin, s as getScriptPreloadAttrs, u as getStylesheetHref } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CikZpi3i.mjs");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BKRH0Tt8.mjs"),
    import("./start-riuIYJ1B.mjs"),
