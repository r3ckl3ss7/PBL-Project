...
const CircleGauge = createLucideIcon("circle-gauge", __iconNode$b);
const __iconNode$a = [
...
const Gauge = createLucideIcon("gauge", __iconNode$7);
const __iconNode$6 = [
...
const ScanFace = createLucideIcon("scan-face", __iconNode$5);
const __iconNode$4 = [
  [
    "path",
    {
